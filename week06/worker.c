...
void signal_handler(int signum) {
    // print info about the number of triangulars found.
...
int main(int argc, char *argv[]) {
    // Get the process_idx from command-line arguments
    if (argc != 2) {
    ...
    while (true) {
        // In an infinite loop, search for the next triangular numbers starting from next_n
